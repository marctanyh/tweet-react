...
class Tweets extends React.Component {
  render () {
    ...
    let tweetList = this.props.hello.map(tweet => {
      ...
      return <div className="col-12 mb-3 d-flex card">
        
        <Tweet profileimage={tweet.user.profile_image_url} 
        username={tweet.user.screen_name} name={tweet.user.name} 
        content={tweet.text.split('<br/>')} 
        date={tweet.created_at} retweetCount={tweet.retweet_count} 
